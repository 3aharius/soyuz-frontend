...
export default class ProjectsList extends React.Component {
	...
	constructor() {
		...
		let projects = [
			{
				id: 1,
				img: DYN_IMAGES_PUBLIC_PATH + 'curious-rover.jpg',
			...
			{
				id: 2,
				img: DYN_IMAGES_PUBLIC_PATH + 'space-station.jpg',
			...
			{
				id: 3,
				img: DYN_IMAGES_PUBLIC_PATH + 'space-shuttle.png',
			...
			{
				id: 4,
				img: DYN_IMAGES_PUBLIC_PATH + 'earth-satellite.jpg',
			...
			{
				id: 5,
				img: DYN_IMAGES_PUBLIC_PATH + 'project-image3.jpg',
